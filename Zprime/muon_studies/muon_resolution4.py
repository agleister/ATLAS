...
This script runs the procedure for making the plots used for muon resolution studies (IP and 3s)
"""
...
def main():
    ...
    loop = pyframe.core.EventLoop(name='muon_resolution_4_3s2s_test', version=version, quiet=False)
