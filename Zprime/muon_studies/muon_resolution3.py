...
This script runs the procedure for making the plots used for muon resolution studies (IP, but no 3s)
"""
...
def main():
    ...
    loop = pyframe.core.EventLoop(name='muon_resolution_3zoom_test', version=version, quiet=False)
